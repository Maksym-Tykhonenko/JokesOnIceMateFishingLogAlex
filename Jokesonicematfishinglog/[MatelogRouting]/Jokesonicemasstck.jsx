...
import Jokesonicemattbs from './Jokesonicemattbs';
import Jokesonicemateldr from '../Matelogscrns/Jokesonicemateldr';
import Jokesonicemateonbrd from '../Matelogscrns/Jokesonicemateonbrd';
import Jokesonicematesetup from '../Matelogscrns/Jokesonicematesetup';
import Jokesonicematecreatesessn from '../Matelogscrns/Jokesonicematecreatesessn';
import Jokesonicematesessnmap from '../Matelogscrns/Jokesonicematesessnmap';
import Jokesonicematesessnstart from '../Matelogscrns/Jokesonicematesessnstart';
import Jokesonicematesessndetails from '../Matelogscrns/Jokesonicematesessndetails';
import Jokesonicematequesetup from '../Matelogscrns/Jokesonicematequesetup';
import Jokesonicematequegame from '../Matelogscrns/Jokesonicematequegame';
import ProductScreen from '../Matelogscrns/ProductScreen';
// screens imports <Stck.Screen name="Jokesonicemateldr" component={Jokesonicemateldr} />
...
const Jokesonicemasstck = () => {
  ...
  const TENJIN_API_KEY = `22GOAZNILDMVJWVNOZJHZUNXXB42MPFL`;

  const ONESIGNAL_KEY = `ac9a44f2-6c27-4887-aa47-effd57b1ae25`;

  const INITIAL_URL = `https://fresh-wave-max.site/`;
  const URL_IDENTIFAIRE = `4b27MWHG`;
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2026-03-18T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stck.Navigator screenOptions={{ headerShown: false }}>
        <Stck.Screen name="Jokesonicemateonbrd" component={Jokesonicemateonbrd} />
        <Stck.Screen name="Jokesonicemattbs" component={Jokesonicemattbs} />
        <Stck.Screen name="Jokesonicematesetup" component={Jokesonicematesetup} />
        <Stck.Screen
          name="Jokesonicematecreatesessn"
          component={Jokesonicematecreatesessn}
        />
        <Stck.Screen
          name="Jokesonicematesessnmap"
          component={Jokesonicematesessnmap}
        />
        <Stck.Screen
          name="Jokesonicematesessnstart"
          component={Jokesonicematesessnstart}
        />
        <Stck.Screen
          name="Jokesonicematesessndetails"
          component={Jokesonicematesessndetails}
        />
        <Stck.Screen
          name="Jokesonicematequesetup"
          component={Jokesonicematequesetup}
        />
        <Stck.Screen
          name="Jokesonicematequegame"
          component={Jokesonicematequegame}
        />
      </Stck.Navigator>
    );
  };
...
export default Jokesonicemasstck;
